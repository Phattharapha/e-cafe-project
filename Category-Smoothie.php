	        ...
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="Home.php" class="nav-link">Home</a></li>
				...
				<div class="dropdown-menu" aria-labelledby="dropdown04">
					...
					<a class="dropdown-item active" href="Category-Smoothie.php">Smoothie</a>
    ...
    <!-- END nav -->
      ...
      <div class="container">
       ...
       <!--   	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Products</span></p>   -->
            <h1 class="mb-0 bread">Smoothie</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
				...
				<ul class="product-category">
						...
						<li><a href="Category-Smoothie.php" class="active">Smoothie</a></li>
...
<?php
			...
			$sql = "select * from product WHERE pro_type = 'Smoothie'";
