    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="Home.php" class="nav-link"  style="color:#FFFFFF; background-color: #82AE46"><strong>Home</strong></a></li>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                    ...
                    <a class="dropdown-item active" href="Category-IceCream.php">Ice Cream Homemade</a>
    ...
    <!-- END nav -->
      ...
      <div class="container">
       ...
       <!--   	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Products</span></p>   -->
            <h1 class="mb-0 bread">Ice Cream Homemade</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
            ...
            <div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li><a href="Category-Milk.php" >Milk</a></li>  <!--  Active = เลือกประเภทนั้นๆ -->
						...
						<li><a href="Category-IceCream.php" class="active">Ice Cream Homemade</a></li>
...
$sql = "select * from product WHERE pro_type = 'IceCream'";
