	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="Home.php" class="nav-link"  style="color:#FFFFFF; background-color: #82AE46"><strong>Home</strong></a></li>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                    ...
                    <a class="dropdown-item active" href="Category-RoastedBread.php">Roasted Bread</a>
    ...
    <!-- END nav -->
      ...
      <div class="container">
       ...
       <!--   	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Products</span></p>   -->
            <h1 class="mb-0 bread">Roasted Bread</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
            ...
            <div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
						...
						<li><a href="Category-RoastedBread.php" class="active">Roasted Bread</a></li>
...
<!--Start MENU -->			
			...
			$sql = "select * from product WHERE pro_type = 'RoastedBread'";
