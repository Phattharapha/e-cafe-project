...
<div>
    	...
    	<!--				<p class="d-flex">
    					...
    					<hr>
    					<p class="d-flex total-price" style="color: #000000">
    						<span>My Queue</span><span class="text-center" style="font-size: 20px; color: #000000"><strong>- 1 -</strong></span>
						</p>
	...
	<div class="table-responsive-sm">
			<table class="table-striped table-bordered" style="width: auto">
  <thead>
      <tr>
	<!--	  <th class="th-sm">ID
 ...
 <!--       <th class="text-lg">Description	
    ...
    <tbody>
      ...
      <!--  <td>2-01-001 </td> -->
        <td style="column-width: ">Milk Tea 
