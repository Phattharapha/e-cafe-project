	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="Home.php" class="nav-link"  style="color:#FFFFFF; background-color: #82AE46"><strong>Home</strong></a></li>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                    ...
                    <a class="dropdown-item active" href="Category-Snack.php">Snack</a>
			    </div>
    	...
    	<div class="container">
            ...
            <div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
						...
						<li><a href="Category-Snack.php" class="active">Snack</a></li>
    				</ul>
    			</div>
			</div>
...
$sql = "select * from product WHERE pro_type = 'Snack'";
