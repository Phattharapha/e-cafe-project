...
<body class="goto-here">
          ...
          <span class="oi oi-menu"></span> Menu
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item cta cta-colored"><a href="admin_Home.php" class="nav-link" style="color:#FFFFFF; background-color: #82AE46"><strong>Home</strong></a></li>
    ...
    <section class="ftco-section ftco-cart mb-2">



        <div class="d-flex justify-content-center">

            <h2 style="font-size:5vw;">Welcome to Del Luna Cafe'</h2>
            ...
            <div class="row">
                <div>
                    <div class="text-center">
                        ...
                        <table id="dtBasicExample" class="table-responsive-sm table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th class="th-sm"> <img src="images/icon1.png" style="display: block; margin: auto;" alt="" width="50%"> </th>

                                    <th> </th>

                                    <th class="th-sm"><img src="images/icon2.png" style="display: block; margin: auto;" alt="" width="50%">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center" style="display: block; margin: auto;">
                                        <h3 class="text-center" style="font-size:5vw;">Menu</h3><br>

                                        <a class="btn btn-info text-center" href="admin_manage-menu.php">Manage</a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <h3 class="text-center" style="font-size:5vw;">User</h3><br>

                                        <a class="btn btn-info text-center" href="admin_manage-user.php">Manage</a>
